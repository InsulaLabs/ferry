...
func printUsage() {
	...
	fmt.Fprintf(os.Stderr, "  %s %s %s %s\n", color.GreenString("records"), color.CyanString("<prefix>"), color.CyanString("delete"), color.CyanString("<uuid-or-locator>"))
	fmt.Fprintf(os.Stderr, "    Delete record by UUID or locator (marks for background cleanup)\n")
	...
	fmt.Fprintf(os.Stderr, "  ferry records users delete \"email:alice@example.com\"\n")
	fmt.Fprintf(os.Stderr, "  \n")
